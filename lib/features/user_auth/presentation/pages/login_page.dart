...
// 👉 import your HomePage here (not ProfilePage)
  ...
  void _signIn() async {
    ...
    if (user != null) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => HomeScreen(), // 👉 Navigate to HomeScreen after login
        ),
      );
    } else {
      ...
      if (googleSignInAccount != null) {
        ...
        if (user != null) {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => HomeScreen(), // 👉 Navigate to HomeScreen after Google SignIn
            ),
          );
        }
      }
